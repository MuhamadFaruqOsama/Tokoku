...
<html lang="en">
  <head>
    ...
    <!-- untuk link css -->
    <link rel="stylesheet" href="assets/style/style_n.css">
  ...
  <div class="container">
    <a class="navbar-brand" href="home.php"><i class="bi bi-arrow-bar-left"></i></a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="transaksi.php">Riwayat Pembelian</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="toko.php">Toko</a>
        </li>
      </ul>
    </div>
  </div>
